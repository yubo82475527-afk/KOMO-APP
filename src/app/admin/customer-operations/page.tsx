      ...
      <section className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-[#d7dee7]/70">
        <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            <AppLink href={`/admin/data-upload${scopeQuery}`} className="rounded-xl bg-[#1f5f8b] px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-[#184e77]" pendingClassName="opacity-70">
              导入客户资料
            </AppLink>
            <AppLink href={`/admin/reports${scopeQuery}`} className="rounded-xl bg-[#eef4f8] px-4 py-2.5 text-sm font-semibold text-[#1f5f8b] transition hover:bg-[#e0edf5]" pendingClassName="opacity-70">
              查看客户报表
            </AppLink>
          </div>
        </div>
